...
import { actionFill } from '../actions/fill';
import { behaviorOperation } from '../behavior/operation';
import { utilGetAllNodes } from '../util';


export function operationFill(context, selectedIDs) {
    var _extent;
    ...
    function getAction(entityID) {
        ...
        return actionFill(entityID, context.projection);
    }
    ...
    operation.tooltip = function() {
        ...
        return disable ?
            t.append('operations.fill.' + disable + '.' + _amount) :
            t.append('operations.fill.description.' + _amount);
    };


    operation.annotation = function() {
        return t('operations.fill.annotation.feature', { n: _actions.length });
    };


    operation.id = 'fill';
    operation.keys = [t('operations.fill.key')];
    operation.title = t.append('operations.fill.title');
